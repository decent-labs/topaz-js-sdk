...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AppInput', 'model/AppOutput', 'model/AppOutputDetailed'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AppInput'), require('../model/AppOutput'), require('../model/AppOutputDetailed'));
  } else {
    // Browser globals (root is window)
    if (!root.TopazApi) {
      root.TopazApi = {};
    }
    root.TopazApi.AppsApi = factory(root.TopazApi.ApiClient, root.TopazApi.AppInput, root.TopazApi.AppOutput, root.TopazApi.AppOutputDetailed);
  }
}(this, function(ApiClient, AppInput, AppOutput, AppOutputDetailed) {
  'use strict';
