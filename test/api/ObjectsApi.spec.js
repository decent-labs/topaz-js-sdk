...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TopazApi.ObjectsApi();
  });
  ...
  describe('ObjectsApi', function() {
    ...
    describe('findObjects', function() {
      it('should call findObjects successfully', function(done) {
        //uncomment below and update the code to test findObjects
        //instance.findObjects(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
